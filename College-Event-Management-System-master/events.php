                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6">                        
                            ...
                            echo 'Google_Form:' . $row['google_form'].'<br>';
                        ...
                        ?>
                            ...
                            <br><br>
                        <?php echo
                             '<a class="btn btn-default" href="register.php" target="blank"> <span class="glyphicon glyphicon-circle-arrow-right"></span>Registration</a>'
                            ?>
                                                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
